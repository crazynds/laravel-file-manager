...
[![Latest Stable Version](http://poser.pugx.org/crazynds/laravel-file-manager/v)](https://packagist.org/packages/crazynds/laravel-file-manager)
[![Total Downloads](http://poser.pugx.org/crazynds/laravel-file-manager/downloads)](https://packagist.org/packages/crazynds/laravel-file-manager)
[![Latest Unstable Version](http://poser.pugx.org/crazynds/laravel-file-manager/v/unstable)](https://packagist.org/packages/crazynds/laravel-file-manager)
[![License](http://poser.pugx.org/crazynds/laravel-file-manager/license)](https://packagist.org/packages/crazynds/laravel-file-manager)
[![PHP Version Require](http://poser.pugx.org/crazynds/laravel-file-manager/require/php)](https://packagist.org/packages/crazynds/laravel-file-manager)

![Laravel File Manager](https://raw.github.com/crazynds/vue-laravel-file-manager/master/src/assets/laravel-file-manager.gif?raw=true)
